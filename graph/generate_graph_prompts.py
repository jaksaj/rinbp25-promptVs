...
class GraphPromptGenerator:
    def __init__(self, num_graphs: int = 2, num_questions: int = 3, max_nodes: int = 10):
...
def main():
    ...
    parser.add_argument("--questions", type=int, default=3, help="Number of questions per graph (default: 3)")
