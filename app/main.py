...
from app.api.routes import prompts, models, prompt_versioning, batch_operations, prompting_techniques, ab_testing
...
app.include_router(prompt_versioning.router, prefix="/api")
